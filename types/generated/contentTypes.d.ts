...
export interface ApiFeedCategoryFeedCategory
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    feed_items: Schema.Attribute.Relation<
      'oneToMany',
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::feed-category.feed-category'
    > &
      Schema.Attribute.Private;
...
export interface ApiFeedItemFeedItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    attachments: Schema.Attribute.Media<'images' | 'videos', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    feed_category: Schema.Attribute.Relation<
      'manyToOne',
      'api::feed-category.feed-category'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::feed-category.feed-category': ApiFeedCategoryFeedCategory;
